...
## Repository Snapshot
- Repository: `jtgsystems/Ollama-Menu`
- Default branch: `main`
- Visibility: `public`
- Summary: Interactive Windows batch menu for 160+ Ollama AI models. Browse, update, and run Llama, Mistral, Gemma, Qwen, DeepSeek, and more with a clean menu-driven interface.
